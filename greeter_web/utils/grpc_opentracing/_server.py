...
import grpc
from utils.grpc_opentracing import grpcext, ActiveSpanSource
    ...
    def _start_span(self, servicer_context, method):
        ...
        try:
            if metadata:
                ...
                span_context = self._tracer.extract(
                    opentracing.Format.TEXT_MAP, dict(metadata))
        ...
        # print(f"span context: trace_id: {span_context.trace_id}, span_id:{span_context.span_id}, parent_id:{span_context.parent_id}")
